...
export default function BlogPostPage({ params }) {
    ...
    const fetchBlogPost = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3001/api/blog/post/${params.id}`,
        );
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3001/api/comment/comments/${params.id}`,
        );
              ...
              <div className="w-12 h-12 rounded-full bg-dark-700 flex items-center justify-center mr-3 overflow-hidden">
                <img
                  src={
                    ...
                    "https://img.freepik.com/free-vector/user-blue-gradient_78370-4692.jpg?t=st=1742215231~exp=1742218831~hmac=f3227a035260b10998b47bbb7f2fb916bada8fa097f5d2a0f586854f94be0bda&w=826"
                  }
                  alt="User Avatar"
        ...
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              >
                <div className="text-white/80 mb-6">{blogPost.contenu}</div>
              </motion.article>
