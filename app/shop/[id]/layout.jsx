...
async function getProduct(id) {
  try {
    const response = await axios.get(`http://localhost:3001/api/product/product/${id}`)
...
export async function generateMetadata({ params }) {
  ...
  if (!product) {
    return {
      ...
      description: 'The requested product could not be found. Browse our collection of handcrafted ceramics at Ceramerro.',
    }
  }
